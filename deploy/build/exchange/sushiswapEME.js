...
exports.sushiswapCreateReturnEntryCall = exports.sushiswapCreateAwayEntryCall = void 0;
...
function sushiswapCreateAwayEntryCall(fromCoin, toCoin, inputAmount, calls, secondaryCalls, awayEntries, i) {
...
exports.sushiswapCreateAwayEntryCall = sushiswapCreateAwayEntryCall;
function sushiswapCreateReturnEntryCall(fromCoin, toCoin, input, calls, secondaryCalls, returnEntries, i) {
    const srcToken = addresses.tokens[fromCoin];
    const destToken = addresses.tokens[toCoin];
    const tokenA = new sdk_1.Token(sdk_1.ChainId.MAINNET, srcToken[0], srcToken[1]);
    const tokenB = new sdk_1.Token(sdk_1.ChainId.MAINNET, destToken[0], destToken[1]);
...
exports.sushiswapCreateReturnEntryCall = sushiswapCreateReturnEntryCall;
